...
class TestCategoryRepository(unittest.TestCase):
    ...
    def test_find_all_by_owner(self):
        category_repository.create(self.testCategory1)
        category_repository.create(self.testCategory2)
        categories = category_repository.find_all_by_owner(
            self.testCategory1.owner)
    ...
    def test_find_by_name_and_owner(self):
        category_repository.create(self.testCategory1)
        category_repository.create(self.testCategory2)
        category = category_repository.find_by_name_and_owner(
            self.testCategory1.name, self.testCategory1.owner)
    ...
    def test_find_by_id(self):
        category_repository.create(self.testCategory1)
        category = category_repository.find_by_id(
            self.testCategory1.category_id)
